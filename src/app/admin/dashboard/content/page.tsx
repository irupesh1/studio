...
export default function ContentPage() {
  ...
  const [aboutContent, setAboutContent] = useLocalStorage("aboutPageContent", {
      title: "About NexaAI",
  ...
  const [versionContent, setVersionContent] = useLocalStorage("versionPageContent", {
  ...
  const versionPageForm = useForm<VersionPageValues>({
      ...
      values: versionContent,
  });

  const [privacyContent, setPrivacyContent] = useLocalStorage("privacyPageContent", {
  ...
  const privacyPageForm = useForm<PrivacyPageValues>({
      ...
      values: privacyContent,
  });

  const [feedbackContent, setFeedbackContent] = useLocalStorage("feedbackPageContent", {
  ...
  const [surveyContent, setSurveyContent] = useLocalStorage("surveyPageContent", {
      title: "Quick Survey",
