                ...
                >
                  {message.role === 'assistant' && (
                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center">
                      <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 218 300" preserveAspectRatio="xMidYMid meet" className="text-primary">
                          <defs>
                          ...
                          <g transform="translate(0.000000,300.000000) scale(0.100000,-0.100000)" fill="url(#logoGradientChat)" stroke="none">
