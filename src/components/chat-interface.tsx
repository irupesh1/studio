...
export function ChatInterface({ messages, setMessages }: ChatInterfaceProps) {
  ...
  const [welcomeTitleColor, setWelcomeTitleColor] = useState("");
  ...
  useEffect(() => {
    ...
    const savedTitleColor = localStorage.getItem("welcomeTitleColor");
    ...
    if (savedTitleColor) setWelcomeTitleColor(savedTitleColor);
